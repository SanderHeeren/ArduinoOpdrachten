...
const int irPin = 2; // Infrarood ontvanger op pin 2
IRrecv irrecv(irPin); // Pin koppelen aan de IR ontvanger
decode_results results; // Results van het ontvangst van de remote

const int ledPins[] = {13, 12, 11, 10}; // Meerdere Led pins in een array
